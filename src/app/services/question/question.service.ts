...
export class QuestionService {
  ...
  searchQuestions(page: number, size: number, property: string, searchString: string): Observable<QuestionResponse> {
    ...
    return this.http.get(`${this.questionsUrl}/search`, { search: searchParams, headers: this.authService.getHeaders() })
      .map(res => res.json())
      .catch(this.handleError);
  }
